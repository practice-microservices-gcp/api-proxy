...
echo "NNNN CONFIG_ID: ${CONFIG_ID}"
echo "NNNN SERVICE: ${SERVICE}"
echo "NNNN PROJECT: ${PROJECT}"
echo "NNNN URL: https://servicemanagement.googleapis.com/v1/services/${SERVICE}/configs/${CONFIG_ID}?view=FULL"
